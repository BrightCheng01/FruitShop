<%@ taglib prefix="page" uri="http://jsptags.com/tags/navigation/pager" %>
        ...
        <div class="body-content">
            <form action="${ctx}/item/exUpdate" method="post" class="form-x" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input w50" name="name" value="${obj.name}" data-validate="required:请输入商品名称">
                        <div class="tips"></div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input w50" name="price"value="${obj.price}" data-validate="required:请输入商品价格">
                        <div class="tips"></div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input w50" name="zk" value="${obj.zk}" data-validate="required:请输入商品折扣">
                        <div class="tips"></div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <select name="categoryIdTwo" class="input w50">
                            <c:forEach items="${types}" var="datas" varStatus="l">
                                <option value="${datas.id}" ${obj.categoryIdTwo == datas.id? "selected" : ""}>${datas.name}</option>
                            </c:forEach>
                        </select>
                ...
                <div class="form-group">
                    <div class="label"><label>商品主图：</label></div>
                    <div class="field">
                        <input type="file" class="input w50" name="file" />
                        <div class="tips"><img src="${obj.url1}" style="width: 150px;height: 150px;"> </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="file" class="input w50" name="file" />
                        <div class="tips"><img src="${obj.url2}" style="width: 150px;height: 150px;"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="file" class="input w50" name="file" />
                        <div class="tips"><img src="${obj.url3}" style="width: 150px;height: 150px;"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="file" class="input w50" name="file" />
                        <div class="tips"><img src="${obj.url4}" style="width: 150px;height: 150px;"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="file" class="input w50" name="file" />
                        <div class="tips"><img src="${obj.url5}" style="width: 150px;height: 150px;"></div>
                    </div>
                </div>
