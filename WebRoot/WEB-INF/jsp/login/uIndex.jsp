...
<!--导航条-->
<div class="width100" style="height: 45px;background: #dd4545;margin-top: 40px;position:
...
<div class="width1200 center_yh hidden_yh" style="position: relative;z-index: 80;">
    <div class="example2" style="width: 1200px;height: 490px;overflow: hidden;margin-left: 230px;">
        <ul>
            <li><img src="${ctx}/resource/images/a.webp" style="height: 100%;" alt=""></li>
            <li><img src="${ctx}/resource/images/b.webp" style="height: 100%;"alt=""></li>
            <li><img src="${ctx}/resource/images/c.webp" style="height: 100%;"alt=""></li>
            <li><img src="${ctx}/resource/images/d.webp" style="height: 100%;"alt=""></li>
        </ul>
    </div>
    <script>
        $(function () {
...
<div class="width1200 center_yh hidden_yh">
    <div class="width100" style="height: 45px;line-height: 45px;border-bottom: 2px solid #dd4545;margin-top: 20px">
        <font class="left_yh font20">热销</font>
    </div>
    <div class="width100 hidden_yh" style="height: 480px">
        <div class="normalPic">
