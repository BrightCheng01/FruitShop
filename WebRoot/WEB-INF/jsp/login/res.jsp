    ...
    <div class="width1200 hidden_yh center_yh" style="margin-top: 75px">
        <form action="${ctx}/login/toRes" method="post">
            <div class="center_yh hidden_yh" style="width: 475px; margin-bottom: 40px">
                <span class="left_yh block_yh tright" style="margin-right: 40px;height: 42px;line-height: 42px; width: 100px;">
                    用户名:
                </span>
                <input type="text" name="userName" placeholder
                        ="请输入您的用户名" style="border:1px solid #c9c9c9;
                         width: 292px; height: 42px;font-size: 16px;text-indent: 22px" class="left_yh"/>
            </div>
            <div class="center_yh hidden_yh" style="width: 475px; margin-bottom: 40px">
                <span class="left_yh block_yh tright" style="margin-right: 40px;height: 42px;line-height: 42px; width: 100px;">
                    设置密码:
                ...
                <input type="text" name="passWord" placeholder
                        ="建议使用两种字符组合" style="border:1px solid #c9c9c9;
                         width: 292px; height: 42px;font-size: 16px;text-indent: 22px" class="left_yh"/>
            </div>
            ...
            <div class="center_yh hidden_yh" style="width: 475px; margin-bottom: 40px">
                ...
                <input type="text" name="phone" placeholder
                        ="建议使用常用手机" style="border:1px solid #c9c9c9;
                         width: 292px; height: 42px;font-size: 16px;text-indent: 22px" class="left_yh"/>
            </div>
            <div class="center_yh hidden_yh" style="width: 475px; margin-bottom: 40px">
                <span class="left_yh block_yh tright" style="margin-right: 40px;height: 42px;line-height: 42px; width: 100px;">
                ...
                <input type="text" name="email" placeholder
                        ="请输入邮箱" style="border:1px solid #c9c9c9;
                         width: 292px; height: 42px;font-size: 16px;text-indent: 22px" class="left_yh"/>
            </div>
