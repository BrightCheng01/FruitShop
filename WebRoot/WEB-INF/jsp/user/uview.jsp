...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipNav">
            <a href="${ctx}/user/uview" class="on">个人信息</a>
            <a href="${ctx}/itemOrder/my" >我的订单</a>
            <a href="${ctx}/sc/findBySql" >收藏商品</a>
            <a href="${ctx}/login/pass" >修改密码</a>
        </div>
        <div id="vipRight">
            <form action="${ctx}/user/exUpdate" id="myf" method="post">
                <div class="hidden_yh bj_fff" style="width: 938px;border:1px solid #ddd;">
                    ...
                    <div class="width100" style="height: 32px;line-height: 32px;margin-top: 50px;">
                            <a  href="javascript:void(0);" class="left_yh block_yh font16 tcenter ff5802 sub"style="width:244px; height: 33px;line-height: 33px; margin-bottom:30px;margin-left: 120px">
                                保存
                            </a>
                    </div>
                </div>
