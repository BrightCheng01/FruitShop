...
<div class="width1198 hidden_yh center_yh" style="border: 1px solid #ddd;margin-top: 18px;min-height: 300px;">
    <div class="width100 hidden_yh font14" style="height: 32px;line-height: 32px;background: #f0f0f0;text-indent: 21px;color: #000;font-weight:600;border-bottom: 1px solid #ddd;">商品详情
    </div>
        ...
        <div class="speCific" data-id="${data.id}">
            ...
            <div class="xzSl">
                <div class="xzSlIn">
                    ...
                    <b class="Aadd" style="border-right: none; border-left: 1px solid #ddd;">加</b>
                </div>
            </div>
...
<div class="width1198 center_yh" style="height: 60px;background: #f0f0f0;border: 1px solid #ddd;margin-top: 40px">
    <div class="center_yh hidden_yh" style="width: 1178px;height: 60px;margin-left: 20px;">
        <div class="ifAll"><b><img src="${ctx}/resource/user/images/xzwxz.png" alt=""></b><font>全选</font></div>
