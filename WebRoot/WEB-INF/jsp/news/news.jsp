    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <tr>
                ...
                <td><a class="button border-main" href="${ctx}/news/update?id=${data.id}"><span class="icon-edit">修改</span></a>
                <a class="button border-red" href="${ctx}/news/delete?id=${data.id}"><span class="icon-trash-o">删除</span></a>
                </td>
