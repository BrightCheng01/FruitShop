...
<div class="panel admin-panel">
            ...
            <ul class="search" style="padding-left: 10px;">
                ...
                <li>
                    <input type="text" placeholder="订单号" name="code" class="input" value="${obj.code}"
                           style="width: 250px;height: 17px;display: inline-block">
    ...
    <table class="table table-hover text-center">
        ...
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <tr>
                <td>${data.code}</td>
                <td><fmt:formatDate value="${data.addTime}" pattern="yyyy-MM-dd HH:mm:s"></fmt:formatDate></td>
                <td>${data.total}</td>
                ...
                <td><a class="button border-main" href="${ctx}/orderDetail/ulist?orderId=${data.id}"><span class="icon-edit">查看购买商品信息</span></a>
                    <c:if test="${data.status == 0}">
