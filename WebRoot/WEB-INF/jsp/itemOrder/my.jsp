                    ...
                    <c:forEach items="${all}" var="data" varStatus="l">
                        <div class="width100 hidden_yh">
                            ...
                            <c:forEach items="${data.details}" var="chil" varStatus="l">
                                <div style="width:838px;border-bottom: 1px solid #ddd;padding-top: 30px;padding-bottom: 30px;" class="hidden_yh center_yh">
                                    ...
                                    <div class="left_yh" style="width: 580px;">
                                        ...
                                        <p class="c_66 font16" style="margin-top: 10px;">折扣:${chil.item.zk}</p>
                                        <p class="red" style="margin-top: 16px;">￥:${chil.item.price}</p>
                                    </div>
                                    <div class="right_yh">
